...
int64_t SeekPlatformFile(PlatformFile file,
...
int ReadPlatformFile(PlatformFile file, int64_t offset, char* data, int size) {
  if (file == kInvalidPlatformFileValue)
    return -1;
...
int ReadPlatformFileNoBestEffort(PlatformFile file, int64_t offset, char* data,
                                 int size) {
...
int WritePlatformFile(PlatformFile file, int64_t offset,
...
bool TruncatePlatformFile(PlatformFile file, int64_t length) {
  if (file == kInvalidPlatformFileValue)
    return false;
