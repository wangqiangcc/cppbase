...
BASE_EXPORT int64_t SeekPlatformFile(PlatformFile file,
...
BASE_EXPORT int ReadPlatformFile(PlatformFile file, int64_t offset,
                                 char* data, int size);
...
BASE_EXPORT int ReadPlatformFileNoBestEffort(PlatformFile file, int64_t offset,
                                             char* data, int size);
...
BASE_EXPORT int WritePlatformFile(PlatformFile file, int64_t offset,
...
BASE_EXPORT bool TruncatePlatformFile(PlatformFile file, int64_t length);
